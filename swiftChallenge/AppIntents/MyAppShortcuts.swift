...
struct HealthAppShortcuts: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
            ...
            AppShortcut(
                ...
                phrases: [
                    "Record my glucose with ${applicationName}",
                    "Log blood sugar reading with ${applicationName}",
                    "Save my glucose level with ${applicationName}",
                    "Enter my blood sugar with ${applicationName}",
                    "Track glucose reading with ${applicationName}",
                    "Add glucose to ${applicationName}"
                ],
                shortTitle: "Record Glucose",
                systemImageName: "drop.fill"
            );
            
            AppShortcut(
                intent: QuickGlucoseIntent(),
                phrases: [
                    "Quick glucose entry with ${applicationName}",
                    "Fast glucose recording with ${applicationName}",
                    "Log \(\.$quickValue) glucose with ${applicationName}",
                    "Record quick glucose with ${applicationName}",
                    "Save quick reading with ${applicationName}"
                ],
                shortTitle: "Quick Glucose",
            ...
            AppShortcut(
                ...
                phrases: [
                    ...
                    "How are my glucose readings with ${applicationName}?",
                    "Help me manage my glucose with ${applicationName}",
                    "Analyze my blood sugar with ${applicationName}",
                    "What should I do about my glucose with ${applicationName}?"
                ],
                shortTitle: "Glucose Analysis",
